      ...
      try {
        ...
        if (userData && userData.profileImage) {
          try {
            ...
            setProfileImageUrl(imageUrlResponse.imageUrl);
          } catch (error) {
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          {profileImageUrl ? (
            ...
            <div className="h-full w-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium text-lg">
